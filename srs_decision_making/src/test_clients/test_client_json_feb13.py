...
if __name__ == '__main__':
    try:
        ...
        json_parameters = '{"tasks":[{"time_schedule":1263798000000,"task":"get","deliver_destination":{"pose2d":{"theta":0.0,"y":0.0,"x":0.0}},"object":{"object_type":"Milkbox"}},{"time_schedule":1263798000000,"task":"move","destination":{"predefined_pose":"order"}}],"initializer":{"device_type":"ui_loc","device_id":"ui_loc_0001"}}' 
